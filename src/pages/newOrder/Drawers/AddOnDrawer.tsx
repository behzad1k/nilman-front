...
const AddOnDrawer = ({
  ...
  console.log(selected.options[currentAttribute.id]);
  return (
    <>
      ...
      {[...currentAttribute?.addOns]?.sort((a, b) => (a?.sort || 1000) - (b?.sort || 1000))?.map((secAttr, index) => (
          ...
          onClick={() => {
            setSelected(prev => {
              ...
              if (!cp.options[currentAttribute.id]) {
                ...
                cp.options[currentAttribute.id].count += 1;
                if (Object.keys(cp.options[currentAttribute.id].addOns).find(e => e == secAttr.id)) {
                  cp.options[currentAttribute.id].addOns[secAttr.id].count += 1;
                }else {
        ...
        >
          ...
          <Box component="div" sx={{
            ...
            {Object.keys(selected.options[currentAttribute.id]?.addOns || {})?.find(e => e == secAttr.id) ?
