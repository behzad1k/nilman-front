        ...
        onClick={() => {
          setSelected(prev => {
            ...
            if (!cp.options[currentAttribute.id]) {
              ...
              console.log(Object.keys(cp.options[currentAttribute.id].addOns));
          ...
          >
        {secAttr.title}
        {selected.options[currentAttribute.id] && Object.keys(selected.options[currentAttribute.id].addOns)?.find(e => e == secAttr.id.toString()) || Object.keys(selected.options).find(e => secAttr.attributes?.map(j => j.id.toString())?.includes(e)) ? <i className={'selectedServiceIcon'}></i> : ''}
      </Typography>
